...
namespace SalesManagment2Project
{
    public partial class Form11 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'database1DataSet11.kasiyerBil' table. You can move, or remove it, as needed.
            this.kasiyerBilTableAdapter2.Fill(this.database1DataSet11.kasiyerBil);
            // TODO: This line of code loads data into the 'database1DataSet5.kasiyerBil' table. You can move, or remove it, as needed.
            this.kasiyerBilTableAdapter1.Fill(this.database1DataSet5.kasiyerBil);
            // TODO: This line of code loads data into the 'database1DataSet4.kasiyerBil' table. You can move, or remove it, as needed.
            this.kasiyerBilTableAdapter.Fill(this.database1DataSet4.kasiyerBil);
            frm1.kasiyerListele();
            try
            {
...
DataGridViewSelectionMode.FullRowSelect;
        ...
        catch
 {
       ...
       DataGridViewCellMouseEventArgs e)
        {
            frm1.frm12.textBox1.Text =
           dataGridView1.CurrentRow.Cells[0].Value.ToString();
            frm1.frm12.textBox2.Text =
           dataGridView1.CurrentRow.Cells[1].Value.ToString();
            frm1.frm12.textBox3.Text =
           dataGridView1.CurrentRow.Cells[2].Value.ToString();
            frm1.frm12.textBox4.Text =
           dataGridView1.CurrentRow.Cells[3].Value.ToString();
            frm1.frm12.textBox5.Text =
           dataGridView1.CurrentRow.Cells[4].Value.ToString();
            frm1.frm12.textBox6.Text =
           dataGridView1.CurrentRow.Cells[5].Value.ToString();
            frm1.frm12.textBox7.Text =
           dataGridView1.CurrentRow.Cells[6].Value.ToString();
            frm1.frm12.textBox8.Text =
           dataGridView1.CurrentRow.Cells[7].Value.ToString();
            frm1.frm12.dateTimePicker1.Text =
           dataGridView1.CurrentRow.Cells[8].Value.ToString();
            frm1.frm12.dateTimePicker2.Text =
