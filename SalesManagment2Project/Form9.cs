...
namespace SalesManagment2Project
{
    public partial class Form9 : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'database1DataSet10.firmabil' table. You can move, or remove it, as needed.
            this.firmabilTableAdapter1.Fill(this.database1DataSet10.firmabil);
            frm1.firmaListele();
            try
            {
               ...
               dataGridView1.CurrentRow.Cells[0].Value.ToString().Trim() != "")
                {
                    frm1.bag.Open();
                    frm1.kmt.Connection = frm1.bag;
                    frm1.kmt.CommandText = "DELETE from firmabil WHERE firmaAdi='"
