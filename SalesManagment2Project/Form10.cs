...
namespace SalesManagment2Project
{
 ...
 frm1.kmt.CommandText = "INSERT INTO         kasiyerbil(ad, soyad, tcKimlik, cepTel, evTel, adres, maas, kasaNo, gorevBaslangici, gorevBitimi) VALUES('" + textBox1.Text + "', '" + textBox2.Text + "', '" + textBox3.Text 
               + "','" + textBox4.Text + "','" + textBox5.Text + "','" + textBox6.Text + "','" +
               
               textBox7.Text + "','" + textBox8.Text + "','" + dateTimePicker1.Text + "','"+ dateTimePicker2.Text + "') ";
                    ...
                    for (int i = 0; i < this.Controls.Count; i++)
                    {
                       ...
                       "";// formdaki tüm textboxların içini boşalt.
                    }
                }
                else
                {
