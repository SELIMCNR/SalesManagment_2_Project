...
namespace SalesManagment2Project
{
    public partial class Form16 : Form
    {
        ...
        void stokUrunAdetKontrol()
        {
            ...
            frm1.kmt.CommandText = "Select adet from stokbil Where urunAdi='" +
           comboBox2.Text + "'";
            SqlDataReader oku;
        ...
        {
            // TODO: This line of code loads data into the 'database1DataSet13.satisbil' table. You can move, or remove it, as needed.
            this.satisbilTableAdapter.Fill(this.database1DataSet13.satisbil);
            frm1.musteriListele();
        ...
        {
                frm1.bag.Open();
                adtr.SelectCommand.CommandText = " Select musteriAdi,musteriSoyadi,tcKimlik,cepTel,evTel,adres From musteribil" + " where("
+ alan + " like '%" + textBox1.Text + "%' )";
                frm1.tabloMusteri.Clear();
                adtr.Fill(frm1.tabloMusteri);
                frm1.bag.Close();
            }
       ...
       DataGridViewCellMouseEventArgs e)
        ...
        private void btnSatisYap_Click(object sender, EventArgs e)
        {
           ...
           textBox4.Text.Trim() != "" && textBox7.Text.Trim() != "" && textBox6.Text.Trim()
           != "")
            {
                stokUrunAdetKontrol();
                if (durum == true)
                {
                    ...
                    frm1.bag.Open();
                    frm1.kmt.Connection = frm1.bag;
                    frm1.kmt.CommandText = "INSERT INTO satisbil(faturaNo, musteriAdi, musteriSoyadi, tcKimlik, urunAdi, satisFiyat, adet, toplamtutar, kasaNo, tarih) VALUES('" + textBox2.Text + "', '" + textBox3.Text + "', '" + 
               ...
               textBox9.Text + "','" + dateTimePicker1.Text + "') ";
                    ...
                    frm1.kmt.CommandText = "UPDATE stokbil SET adet=adet-'" + adet
                   + "' WHERE urunAdi='" + comboBox2.Text + "' ";
        ...
        private void textBox7_TextChanged(object sender, EventArgs e)
        {
            try
            {
                textBox8.Text = (int.Parse(textBox6.Text) *
               int.Parse(textBox7.Text)).ToString();
            }
            catch
            {
                ;
