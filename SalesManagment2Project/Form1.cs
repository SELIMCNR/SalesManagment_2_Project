...
namespace SalesManagment2Project
{
    public partial class Form1 : Form
    {
        ...
        public SqlConnection bag = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=|DataDirectory|\database1.mdf;Integrated Security=True");
        //bağlantı değişkeni tanımlanıyor
        public DataTable tabloMusteri = new DataTable();//sanal tablo değişkeni 

        public DataTable tabloUrun = new DataTable();//sanal tablo değişkeni 

        public DataTable tabloKategori = new DataTable();//sanal tablo değişkeni 

        public DataTable tabloFirma = new DataTable();//sanal tablo değişkeni 


        public DataTable tabloKasiyer = new DataTable();//sanal tablo değişkeni 

        public DataTable tabloStok = new DataTable();//sanal tablo değişkeni 

        public DataTable tabloSatis = new DataTable();//sanal tablo değişkeni 

        public SqlCommand kmt = new SqlCommand();//sql komut kullanımı değişkeni 
        ...
        public void gununSatisListele()
        {
            ...
            adtr.Fill(tabloSatis);// tabloSatis sanal tablosunu adaptördeki veri 

            dataGridView1.DataSource = tabloSatis;//dataGridView1'in veri kaynağı 
        ...
        public void tcKimlikKasiyerKontrol()
        {
            ...
            if (sayTcKimilk > 0) durum = true;//eğer sayTcKimlik büyük 0 ise yani 
            bag.Close();
        }
        public void tcKimlikKontrol()
        {
            ...
            bag.Open();
            kmt.Connection = bag;
            kmt.CommandText = "Select Count (tcKimlik) from musteribil Where tcKimlik = '" + frm2.frmtext + "'";
            sayTcKimilk = byte.Parse(kmt.ExecuteScalar().ToString());
        ...
        public void urunComboEkle()//girilen kayıtların otomatik olarak combolarda 
        {
            ...
            while (oku.Read())//okunacak kayıt var olduğu sürece
            {
                ...
                if (frm13.comboBox1.Items.IndexOf(oku[0].ToString()) == -1 &&
               oku[0].ToString().Trim() != "") frm13.comboBox1.Items.Add(oku[0].ToString());
                ...
                if (frm15.comboBox1.Items.IndexOf(oku[0].ToString()) == -1 &&
               oku[0].ToString().Trim() != "") frm15.comboBox1.Items.Add(oku[0].ToString());
            }
            bag.Close();
            oku.Dispose();
        }
        ...
        public void urunSatisComboEkle()//girilen kayıtların otomatik olarak 
        {
            ...
            while (oku.Read())
            {
                ...
                if (frm16.comboBox2.Items.IndexOf(oku[0].ToString()) == -1 &&
               oku[0].ToString().Trim() != "") frm16.comboBox2.Items.Add(oku[0].ToString());
        ...
        public void urunSatisFiyatTextEkle()//girilen kayıtların otomatik olarak combolarda gözükmesini sağlıyor.
        {
            ...
            while (oku.Read())
            {
                ...
                if (frm16.comboBox2.Text == oku[0].ToString())
                    frm16.textBox6.Text = oku[1].ToString();
        ...
        public void firmaComboEkle()//girilen kayıtların otomatik olarak combolarda gözükmesini sağlıyor.
        {
            ...
            while (oku.Read())
            {
                if (frm5.comboBox1.Items.IndexOf(oku[0].ToString()) == -1 &&
               oku[0].ToString().Trim() != "") frm5.comboBox1.Items.Add(oku[0].ToString());
        ...
        public void kategoriComboEkle()//girilen kayıtların otomatik olarak combolarda gözükmesini sağlıyor.
        {
            ...
            while (oku.Read())
            {
                ...
                if (frm5.comboBox2.Items.IndexOf(oku[0].ToString()) == -1 &&
               oku[0].ToString().Trim() != "") frm5.comboBox2.Items.Add(oku[0].ToString());
        ...
        {
            // TODO: This line of code loads data into the 'database1DataSet6.satisbil' table. You can move, or remove it, as needed.
            this.satisbilTableAdapter1.Fill(this.database1DataSet6.satisbil);
            // TODO: This line of code loads data into the 'database1DataSet.satisbil' table. You can move, or remove it, as needed.
            this.satisbilTableAdapter.Fill(this.database1DataSet.satisbil);
        ...
        private void kasiyerİşlemleriToolStripMenuItem_Click(object sender, EventArgs e)
        {
            frm11.ShowDialog();
        }
        ...
        private void btn_SatisGoster(object sender, EventArgs e)
        {
            gununSatisListele();
        }
    }
