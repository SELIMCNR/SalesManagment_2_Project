...
namespace SalesManagment2Project
{
    public partial class Form5 : Form
    {
        ...
        frm1.urunKoduKontrol();
            if (frm1.durum == false)
            {
                if (textBox1.Text.Trim() != "" && textBox2.Text.Trim() != "")
                {
                    ...
                    frm1.kmt.CommandText = "INSERT INTO  urunbil(urunAdi, urunKodu, firmaAdi, alisFiyati, satisFiyati, kategori) VALUES('" + textBox1.Text + "','" + textBox2.Text + "','" + comboBox1.Text + "','" +textBox3.Text + "','" + textBox3.Text + "','" +comboBox2.Text + "') ";
        ...
        {
            frm1.frm9.ShowDialog();//form9 i aç
        }
